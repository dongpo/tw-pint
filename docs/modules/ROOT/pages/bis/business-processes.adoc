...
The core parties are seller and buyer. Optional parties include payment receiver, delivery party, seller tax representative, and other parties inherited from PINT and UBL.
